...
function CarouselReact ({photo ,outside, heightContainer, widthContainer, styleContainer}){
        ...
        const mergedHeight = heightContainer ?? parms.styleCarousel.container.height
        const mergedContainer = {
            ...container,
            height : mergedHeight
        }
        const navStyle = outside ? {...parms.styleCarousel.navigation,...{width:'100%'}} : {...parms.styleCarousel.navigation}
        const numberStyle = outside ? {...parms.styleCarousel.number,...{top:'0'}} : {...parms.styleCarousel.number}
            ...
            return (
                <div style={mergedParentContainer}>
                     <div style={navStyle}>
                            ...
                            <div onClick={handlePrevClick} style={mergedNavIcon}><FaAngleLeft/></div>
                            <div onClick={handleNextClick} style={mergedNavIcon}><FaAngleRight/></div>
                        </div>
